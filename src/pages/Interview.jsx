        ...
        <section className='bg-white p-8 px-10 flex justify-between '>
         <div className='w-1/2'>
            ...
            <span className='font-semibold text-right'>
                <p className='text-[36px] '>Joseph Micheal</p>
                <p className='text-lg'>Product Designer</p>
                <p className='text-sm text-[#FFCA14]'>Ready to work</p>
            </span>
            </header>
            <article className='flex flex-col gap-4 mt-10 text-lg'>
         ...
         <div className='w-[40%] text-2xl'>
          ...
          <p className='text-lg'>https://www.figma.com/file/SzMGvwwGrFUnekP7MEljEx/AurBase-Tech?node-id=140%3A1790
</p>
         </div>
