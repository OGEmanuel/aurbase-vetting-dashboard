...
const ForgetCard = () => {
  return (
    <div className='bg-white   border border-red-500 px-20 py-10' >
    <div className='flex justify-end'><img src={Close} alt="" /></div>
    <div className='flex justify-center'><img src={Logo} alt="" /></div>
     <p className='text-center mt-4 text-[45px] font-semibold'>Forget Password</p>
     <p className='text-center mt-4 w-[75%] mx-auto'>Kindly enter the email address associated to your account to reset your password </p>
     <form action="">
