...
const Personality4 = () => {
  return (
    <section className='flex flex-col-reverse md:flex-row justify-between items-start bg-white p-8 mt-5 rounded'>
...
<p className='text-[12px] md:text-lg md:mt-5'>You have completed the Personality Test, please take the Language Proficiency Test to be on track.</p>
