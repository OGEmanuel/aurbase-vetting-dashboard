...
const Personality1 = ({onClick}) => {
  return (
    <section className='flex items-center bg-white p-8 mt-5 rounded pb-14'>
        <div>
            <p className='text-[30px]'>Personality Test</p>
            <h3 className='text-[40px] text-[#121212] font-semibold '>Be yourself and answer
honestly to give insight on
your personality type</h3>
    <p className='text-lg w-[80%] mt-4'>There are no wrong answers, test take 10 - 15 minutes </p>
