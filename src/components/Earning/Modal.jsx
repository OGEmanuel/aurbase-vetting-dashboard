...
const Modal = () => {
  ...
  return (
    <main className='bg-white p-5 w-[750px] rounded-[10px] mx-auto '>
    <div className='flex justify-between border-b-2 border-[#3A3A3A1A] '><p className='font-semibold text-2xl'>Select withdrawal Method</p><span onClick={handleClick}><img src={Cancel} alt="" /></span></div>
    <section className='flex justify-center border-b-2 border-[#3A3A3A1A] pb-7'>
        <div>
            <p className='mt-[30px]'>International Payment</p>
            <span className='mt-[16px] block'><img src={Perfect} alt="perfect-logo" /></span>
            <p className='mt-[20px]'>Local Bank  payment</p>
            <p className='mt-[16px]'>N:B Local Bank payments are not supported Yet.</p>
        </div>
        <div className='border-l-2 border-[#3A3A3A1A] pl-4 max-w-[375px]'>
            ...
            <div className='flex items-center gap-2 mt-[21px]'><span><img src={Info} alt="info" /></span> <p className='text-[12px]'>Your Account name must match the name___ on your account.</p></div>
