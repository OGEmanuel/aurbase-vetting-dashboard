...
const Education = () => {
  return (
    <Card className="z-[9000] fixed top-[50%] left-[60%] translate-x-[-50%] translate-y-[-50%] scroll overflow-auto h-[30rem]">
      <div className="flex justify-between mb-5">
        <p className="font-semibold text-[2.5rem]">Bio data</p>
        <button>
          <img src={close} alt="" />
        </button>
      </div>
      <div className="font-semibold mb-7">
        <p className="text-2xl mb-5">Profile Picture(Compulsory)</p>
        <div className="flex items-center gap-5">
          <img src={user} alt="user" />
          <button className="text-[0.9375rem] border border-extra-6 rounded-custom-sm bg-bg-3 px-5 py-2.5">
      ...
      <form
        action=""
        className="grid grid-rows-[repeat(5,_minmax(0,_max-content))] grid-cols-[repeat(2,_minmax(0,_max-content))] w-max gap-10"
      >
        ...
        <div className="col-[1_/_-1] w-max ml-auto font-semibold text-lg flex gap-5">
          <button
            type="button"
