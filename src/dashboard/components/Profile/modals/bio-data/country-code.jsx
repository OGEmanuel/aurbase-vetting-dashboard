...
const SelectCountryCode = () => {
  ...
  const usFlag = `https://flagpedia.net/data/flags/h20/us.webp`;

  const [flagImg, setFlagImg] = useState(usFlag);
  ...
  const countryFlagHandler = () => {
    ...
    setFlagImg(
      `https://flagpedia.net/data/flags/h20/${select.selectedOptions[0].dataset.countrycode.toLowerCase()}.webp`
    );
  };
  ...
  return (
    <div className="tel-box">
      ...
      <input type="tel" className="tel" placeholder="+1 638 542 5572" />
    </div>
  );
};
