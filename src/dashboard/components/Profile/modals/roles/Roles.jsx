...
const Roles = () => {
  ...
  return (
    <div className="bg-white px-6 md:px-12 rounded-custom-sm w-[88.5%] max-width xl:w-auto z-[9000] fixed md:absolute top-1/2 md:top-[60rem] left-[50%] xl:left-[60%] translate-x-[-50%] translate-y-[-50%] h-[30rem] scroll overflow-auto pb-10 md:h-auto">
